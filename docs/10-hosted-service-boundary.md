...
## Future default stack

The source direction suggests reuse of existing founder infrastructure:
...
Treat this as a likely implementation default rather than a constraint on the open-source TypeScript CLI.
...
The founder has accepted product risk and does not require a concierge pilot, but hosted complexity should still follow demonstrated open-source use.
