...
- provider pull requests begin without founder solicitation;
...
## Explicit founder constraints

The founder does not require a paid concierge pilot before building and accepts the risk of overbuilding. The implementation plan therefore prioritizes a polished, star-capable open-source product over the minimum experiment needed to validate willingness to pay.
